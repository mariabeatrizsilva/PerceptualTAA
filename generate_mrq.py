...
LEVEL_PATH = "/Game/Maps/Demonstration" 
SEQUENCE_PATH = "/Game/Sequences/ShortFlythrough" 
...
OUTPUT_BASE_DIRECTORY = os.path.expanduser("~/Documents/PerceptualTAA/RenderedFrames_9-10-2025/")
